...
for participant in participants:
    ...
    #Hacky fixes
    if participant == 'sub-CC120212':
        minDur_buttonEvents = 0.04
    if participant == 'sub-CC120264': 
        minDur_buttonEvents = 0.1
    if participant == 'sub-CC221373':
        minDur_buttonEvents = 0.1
    if participant == 'sub-CC221511':
        minDur_buttonEvents = 0.1
    if participant == 'sub-CC221980':
        minDur_buttonEvents = 0.1
    if participant == 'sub-CC223286':
        button_triggerValue = 500
    if participant == 'sub-CC320002':
        minDur_buttonEvents = 0.1
    if participant == 'sub-CC320022':
        minDur_longEvents = 0.08
    if participant == 'sub-CC410097':
        raw_fname = pathlib.Path('/megdata/camcan/camcan/meg11_0272_cc410097/111020/task_raw.fif')
    if participant == 'sub-CC410182':
        minDur_longEvents = 0.1
    if participant == 'sub-CC510226':
        minDur_longEvents = 0.04
    if participant == 'sub-CC520279':
        minDur_longEvents = 0.04
    if participant == 'sub-CC520517':
        minDur_buttonEvents = 0.01
    if participant == 'sub-CC610462':        
        raw_fname = pathlib.Path('/megdata/camcan/camcan/meg11_0279_cc610462/111031/task_real_raw.fif')
    if participant == 'sub-CC610653':
        minDur_buttonEvents = 0.1
    if participant == 'sub-CC620118':
        minDur_buttonEvents = 0.1
    if participant == 'sub-CC620610':
        minDur_buttonEvents = 0.1
    if participant == 'sub-CC710551':
        minDur_buttonEvents = 0.1
    if participant == 'sub-CC710982':
        minDur_buttonEvents = 0.1
    if participant == 'sub-CC711244':
        raw_fname = pathlib.Path('/megdata/camcan/camcan/meg12_0038_cc711244/120224/task_raw.fif')
    if participant == 'sub-CC721888':
        minDur_longEvents = 0.04
    if participant == 'sub-CC721894':
        raw_fname = pathlib.Path('/megdata/camcan/camcan/meg13_0184_cc721894/130416/task1_raw.fif')
